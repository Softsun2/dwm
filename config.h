...
static const char *lthemecmd[] = { "themecontrol", "load", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_F5,     loadtheme,        {.v = lthemecmd } },	    // load theme and reload xresources colors
...
/*
  F5 -> load xcolors to dwm

  goal: F5 -> load current theme to xcolors -> load xcolors
			  script -> xrd()
*/
